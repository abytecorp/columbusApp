  ...
  <nav id='sidebar' className='sidebar'>
    <div className='sidebar-content '>
      <a className='sidebar-brand' href='index.html'>
        ...
        <span className='align-middle'>ColumbusApp</span>
      </a>
      ...
      <ul className='sidebar-nav'>
        ...
        <li className='sidebar-item active'>
          ...
          <ul id='dashboards' className='sidebar-dropdown list-unstyled collapse show' data-parent='#sidebar'>
            ...
            <li className='sidebar-item'><a className='sidebar-link' href='dashboard-analytics-1.html'>Analytics</a></li>
        ...
        <li className='sidebar-item'>
          <a href='#pages' data-toggle='collapse' className='sidebar-link collapsed'>
            <i className='align-middle' data-feather='layout' /> <span className='align-middle'>Pages</span>
          </a>
          <ul id='pages' className='sidebar-dropdown list-unstyled collapse ' data-parent='#sidebar'>
            ...
            <li className='sidebar-item'><a className='sidebar-link' href='pages-projects.html'>Projects <span className='sidebar-badge badge badge-primary'>New</span></a></li>
            ...
            <li className='sidebar-item'><a className='sidebar-link' href='pages-tasks.html'>Tasks <span className='sidebar-badge badge badge-primary'>New</span></a></li>
        ...
        <li className='sidebar-item'>
          <a href='#layouts' data-toggle='collapse' className='sidebar-link collapsed'>
            <i className='align-middle' data-feather='monitor' /> <span className='align-middle'>Layouts</span>
          </a>
          <ul id='layouts' className='sidebar-dropdown list-unstyled collapse ' data-parent='#sidebar'>
            <li className='sidebar-item'><a className='sidebar-link' href='layouts-sidebar-sticky.html'>Sticky Sidebar</a></li>
            <li className='sidebar-item'><a className='sidebar-link' href='layouts-sidebar-collapsed.html'>Collapsed Sidebar</a></li>
            <li className='sidebar-item'><a className='sidebar-link' href='layouts-boxed.html'>Boxed Layout</a></li>
            <li className='sidebar-item'><a className='sidebar-link' href='dashboard-analytics.html?theme=classic'>Classic Theme</a></li>
            <li className='sidebar-item'><a className='sidebar-link' href='dashboard-analytics-2.html?theme=corporate'>Corporate Theme <span className='sidebar-badge badge badge-primary'>New</span></a></li>
            <li className='sidebar-item'><a className='sidebar-link' href='dashboard-analytics-3.html?theme=modern'>Modern Theme <span className='sidebar-badge badge badge-primary'>New</span></a></li>
          </ul>
        </li>
        <li className='sidebar-item'>
        ...
        <li className='sidebar-item'>
          ...
          <ul id='charts' className='sidebar-dropdown list-unstyled collapse ' data-parent='#sidebar'>
            ...
            <li className='sidebar-item'><a className='sidebar-link' href='charts-apexcharts.html'>ApexCharts <span className='sidebar-badge badge badge-primary'>New</span></a></li>
          </ul>
        </li>
        <li className='sidebar-item'>
          ...
          <ul id='multi' className='sidebar-dropdown list-unstyled collapse' data-parent='#sidebar'>
            <li className='sidebar-item'>
              ...
              <ul id='multi-2' className='sidebar-dropdown list-unstyled collapse'>
                <li className='sidebar-item'>
                  <a className='sidebar-link' href='home'>Item 1</a>
                  <a className='sidebar-link' href='home'>Item 2</a>
                </li>
              </ul>
            </li>
            <li className='sidebar-item'>
      ...
      <div className='sidebar-bottom d-none d-lg-block'>
        <div className='media'>
          ...
          <div className='media-body'>
            ...
            <div>
              <i className='fas fa-circle text-success'> Online </i>
            </div>
          </div>
        </div>
      </div>
